...
SECRET_KEY = 'django-insecure-p_)jd76dxd)f3sg77900#0i(4d!_vi8_m=u(x8w#z65x752'\
 '-@'
...
# Expire la session quand l'utilisateur ferme le navigateur
...
# URL de redirection pour les vues @login_required
LOGIN_URL = 'connexion'